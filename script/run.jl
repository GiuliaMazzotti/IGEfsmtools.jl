...
const settings = Dict(
    ...
    "file_path" => "C:/Users/navarrel/Documents/Workspace/Data/s2m/postes/meteo/FORCING_alpes_2017080106_2024080106.nc", # change it
    ...
    "list_id" => "all", #"all", #[5079402, 5181002, 38375402, 5101003, 74056416, 5063402, 73071403] # for s2m poste only
    "landcover" => Int32(1), # only for glacier simu (now only adapted in init_point)
    "out_file" => "C:/Users/navarrel/Documents/Workspace/Data/outputs/output_2017-2024_S2M_allstations.nc",
    "output_vars" => ["Ds", "Tsnow1", "Tsnow2", "Tsnow3", "Tsrf", "asrf_out", "Sice", "Sliq", "SWE", "Sbsrf", "meltflux_out", "Roff_snow", "Roff", "Tsoil1", "Tsoil2", "Tsoil3", "Tsoil4"], # "Icemlt",
)
